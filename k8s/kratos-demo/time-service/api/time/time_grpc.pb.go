...
func (c *timeClient) GetTime(ctx context.Context, in *GetTimeRequest, opts ...grpc.CallOption) (*GetTimeReply, error) {
	out := new(GetTimeReply)
	err := c.cc.Invoke(ctx, "/api.time.Time/GetTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTimeServer) GetTime(context.Context, *GetTimeRequest) (*GetTimeReply, error) {
...
func _Time_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.time.Time/GetTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServer).GetTime(ctx, req.(*GetTimeRequest))
	}
